...
public class SoapToRest {
	...
	final String chemin = System.getProperty("user.dir")+"\\auth.txt";//"G:\\Sys_Win\\MyProgramme\\20. Java_ee\\SoapImpl\\WebContent\\WEB-INF\\authFile\\auth.txt";
	final String cheminTemp = System.getProperty("user.dir")+"\\authTemp.txt"; //"G:\\Sys_Win\\MyProgramme\\20. Java_ee\\SoapImpl\\WebContent\\WEB-INF\\authFile\\authTemp.txt";
	...
	public boolean inscription(String pseudoInscrit, String mdpSend, String mdpVerification){
		...
		if(!mdp.equals(mdpValide)){
			...
			try{
				...
				System.out.println("Impossible de cr̩er le fichier auth.txt");
				e.printStackTrace();
			}
			return true;
		}
	...
	public boolean getOut(String pseudoSupp,String Pass ){
		...
		FileToDelete = new File(System.getProperty("user.dir")+"\\auth.txt");
		FileToDelete.delete();
		FileToRename = new File(System.getProperty("user.dir")+"\\authTemp.txt");
		FileToRename.renameTo(new File(System.getProperty("user.dir")+"\\auth.txt"));
		if(supp){
			return true;
		}
		else{
